...
import streamlit as st 
from app_1 import fig_1,fig_2,fig_3,fig_4,fig_5, df_medias,df_medias_1,df_virada
...
cols_perfil_2 = st.columns(2)
with cols_perfil_2[0]:
...
cols_perfil_3 = st.columns(2)
with cols_perfil_3[0]:
